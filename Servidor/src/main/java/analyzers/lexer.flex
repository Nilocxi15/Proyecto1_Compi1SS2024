...
<YYINITIAL> {fechaModificacion} {System.out.println("Reconocio "+yytext()+" fecha de modificacion"); return new Symbol(Symbols_main.FechaModificacion, (yycolumn + 1), (yyline + 1), yytext());}
