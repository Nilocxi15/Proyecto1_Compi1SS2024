...
<YYINITIAL> {password} {System.out.println("Reconocio "+yytext()+" password"); return new Symbol(Symbols.Password, (yycolumn + 1), (yyline + 1), yytext());}
<YYINITIAL> {nombreSentencia} {System.out.println("Reconocio "+yytext()+" sentencia nombre"); return new Symbol(Symbols.NameSentence, (yycolumn + 1), (yyline + 1), yytext());}
<YYINITIAL> {institution} {System.out.println("Reconocio "+yytext()+" institucion"); return new Symbol(Symbols.Institution, (yycolumn + 1), (yyline + 1), yytext());}
